...
import '../../create_brand/widgets/rounded_choice_chip.dart';
        ...
        child: Column(
          ...
          children: [
                ...
                checkboxTheme: CheckboxThemeData(
                  fillColor: WidgetStateProperty.resolveWith((states) {
                    if (states.contains(WidgetState.selected)) {
                      return AbColors.primary; // ✅ inner box background when checked
                    }
                    return Colors.grey.shade300; // unselected background
                  }),
            ...
            SizedBox(
              ...
              child: ElevatedButton(onPressed: (){}, style: ElevatedButton.styleFrom(backgroundColor: AbColors.primary, foregroundColor: Colors.white),child: const Text('Save')),
            ),
            const SizedBox(height: AbSizes.spaceBtwInputFields * 2)
          ],
        ),
